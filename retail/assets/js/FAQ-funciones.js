...
var nextListener = (a) => {
    ...
    switch (btn.id) {
      ...
      case 'm1-q2-next': 
        ...
        let pantalla2_nueva3 = document.getElementById('Respuesta4_3');
        let pantalla2_nueva4 = document.getElementById('Respuesta4_4');
        ...
        else if(opcion3_2.components['gui-radio'].data.checked) {pantalla2_nueva3.setAttribute('scale', '1 1 1');} 
        else if(opcion4_2.components['gui-radio'].data.checked) {pantalla2_nueva4.setAttribute('scale', '1 1 1');} 
...
function nextListener2(id) {
  ...
  switch (btn.id) {
    ...
    case 'm1-q2-next': 
      ...
      let pantalla2_nueva2 = document.getElementById('Respuesta4_2');
      let pantalla2_nueva3 = document.getElementById('Respuesta4_3');
      let pantalla2_nueva4 = document.getElementById('Respuesta4_3');
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const retroceder_R4_3 = document.querySelector('#atras_R4_3');
  const retroceder_R4_4 = document.querySelector('#atras_R4_4');
  const Respuesta4_1 = document.querySelector('#Respuesta4_1');
  const Respuesta4_2 = document.querySelector('#Respuesta4_2');
  const Respuesta4_3 = document.querySelector('#Respuesta4_3');
  const Respuesta4_4 = document.querySelector('#Respuesta4_4');
  ...
  if (retroceder_R4_3) retroceder_R4_3.addEventListener('click', function (e) {
    Respuesta4_3.setAttribute('scale', '0.001 0.001 0.001');
    Respuesta4.setAttribute('scale', '1 1 1');
  })
  if (retroceder_R4_4) retroceder_R4_4.addEventListener('click', function (e) {
    Respuesta4_4.setAttribute('scale', '0.001 0.001 0.001');
    Respuesta4.setAttribute('scale', '1 1 1');
  })
})